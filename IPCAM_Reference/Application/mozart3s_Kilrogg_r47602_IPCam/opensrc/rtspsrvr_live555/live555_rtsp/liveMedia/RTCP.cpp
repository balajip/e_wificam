...
#endif
      SendRTCPFirst = True; //Added to check RTCP First Packet
...
void RTCPInstance::addSR() {
  ...
  {
       //rtpTimestamp = fSink->convertToRTPTimestamp(timeNow);
       rtpTimestamp = fSink->presetNextTimestamp(); //added newely
  }
