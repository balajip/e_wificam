...
void OnDemandServerMediaSubsession 
::SyncWithServerTimeStamp( void* streamToken) 
{
   StreamState* streamState = (StreamState*)streamToken;
   streamState->SendRTCPFirstPacket();
}
...
#if 1        
    fRTPSink->fNextTimestampHasBeenPreset = False; 
    //fRTCPInstance->SendRTCPFirst = True; 
    fRTCPInstance->sendReport(); 
    fRTPSink->fNextTimestampHasBeenPreset = True; 
#endif
...
// Added to CHeck RTCPInstance
void StreamState::SendRTCPFirstPacket() {
