...
public:
  ...
  // Set / Reset the flag
  void SetReset( bool Reset ) { bReset = Reset ; }
  ...
  int SessionTrackID() { return iTrackId; } // Added to declare TrackId
  ...
  void deleteAllSubsessions();
   ...
   //virtual void SyncWithServerTimeStamp( void* streamToken );
protected:
...
private:
  ...
  int iTrackId; //added track id to identify the stream
  bool bReset ;
};
...
public:
  ...
  virtual void getAbsoluteTimeRange(char*& absStartTime, char*& absEndTime) const;
   ...
   virtual void SyncWithServerTimeStamp( void* streamToken ) = 0;
