...
public:
  ...
  void setCodecType(ECodecType eCType) { CodecType = eCType ; } // Added codec type Newly
  ECodecType getCodecType() { return CodecType ; } // Added codec type newly

   int GetTrackIdFromSource(){ return FramedSource_TrackId ;}//Added newly
...
private:
  ...
  ECodecType  CodecType ; // Added for getting Codec Type 
};
