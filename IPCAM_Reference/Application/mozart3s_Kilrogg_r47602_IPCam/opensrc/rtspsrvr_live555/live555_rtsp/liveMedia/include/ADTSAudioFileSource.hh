...
public:
  static ADTSAudioFileSource* createNew(UsageEnvironment& env,
				       char const* fileName,HANDLE,int,u_int8_t,u_int8_t,char *configstr,int);
...
private:
  ADTSAudioFileSource(UsageEnvironment& env, FILE* fid,HANDLE hlmsrc,
		      u_int32_t samplingFrequencyIndex, u_int8_t channelConfiguration,u_int8_t profile,char*Configstr,int);
