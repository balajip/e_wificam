...
public:
  ...
  createNew(UsageEnvironment& env, FramedSource* inputSource, Boolean leavePresentationTimesUnmodified ,HANDLE,int);

protected:
  MPEG4VideoStreamDiscreteFramer(UsageEnvironment& env,
				 FramedSource* inputSource, Boolean leavePresentationTimesUnmodified,HANDLE,int);
...
protected:
  ...
  SCODE LiveMediaSrc_MPEG4_GetUBuffer(HANDLE hLMSrc, TLMSrcUBufInfo *ptUBuffInfo);
  SCODE LiveMediaSrc_MPEG4_ReleaseUBuffer(HANDLE hLMSrc, TLMSrcUBufInfo *ptUBuffInfo);
  SCODE LiveMediaSrc_MPEG4_EventHandler(HANDLE hLMSrc, ELMSrcEventType eType);
