...
public:
  static ADTSAudioFileServerMediaSubsession*
     createNew(UsageEnvironment& env, char const* fileName, Boolean reuseFirstSource,HANDLE,int,int,int,char*,int);

protected:
  ADTSAudioFileServerMediaSubsession(UsageEnvironment& env,
				      char const* fileName, Boolean reuseFirstSource,HANDLE,int,int,int,char*,int);
