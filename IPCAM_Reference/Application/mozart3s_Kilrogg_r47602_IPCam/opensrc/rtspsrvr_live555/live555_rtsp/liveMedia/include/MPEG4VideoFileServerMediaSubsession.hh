...
public:
  ...
  createNew(UsageEnvironment& env, int Track, Boolean reuseFirstSource,u_int8_t profileid,char const * configstr,int ,HANDLE);
...
protected:
  MPEG4VideoFileServerMediaSubsession(UsageEnvironment& env,
				      int Track, Boolean reuseFirstSource,u_int8_t profileid,char const * configstr,int,HANDLE);
