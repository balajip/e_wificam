...
VENCMASTER_CONFIG = CONF_FILE_PREFIX .."vencmaster_conf.xml"
...
if REQUEST_METHOD == "GET" then
	...
	tempfile = io.open(VENC_FILE, "r")
        ...
        _, _, head, venc_videoin, tail = string.find(temp_buf, "(.*)(<venc_master>.-</venc_master>)(.*)")
...
--print (venc_new_file)
		...
		os.execute("/usr/bin/dos2unix.sh  "..VENCMASTER_CONFIG.."  >  /dev/null  2>&1")
