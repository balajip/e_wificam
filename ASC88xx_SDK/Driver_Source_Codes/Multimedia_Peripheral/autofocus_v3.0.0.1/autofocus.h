...
/* ============================================================================================== */
#define AUTOFOCUS_VERSION MAKEFOURCC(3, 0, 0, 1)
#define AUTOFOCUS_ID_VERSION "3.0.0.1"
/* ============================================================================================== */
...
/* AF initial param */
typedef struct autofocus_init_options
{
...
{
	int (*open)(TAutoFocusInitOptions* param);
	int (*release)(void);
	int (*set_options)(TVideoSignalOptions *ptArg);
	int (*one_frame)(TAutoFocusState *state);
} TAutoFocusModule;
/* ============================================================================================== */
