/*
 * $Header: /rd_common/common_header/typedef.h 30    13/06/26 4:51p Frank.yang $
 *
 * Driver for EDMC.
 *
 ...
 * 
 * *****************  Version 30  *****************
 * User: Frank.yang   Date: 13/06/26   Time: 4:51p
 * Updated in $/rd_common/common_header
 * 1. Revert back to version 28 since 29 is an accidential check in.
 * 
 * *****************  Version 28  *****************
