 ...
 */
#ifndef __MT9M034_LOCALS_H__
#define __MT9M034_LOCALS_H__
#endif
#ifndef __KERNEL__
#define __KERNEL__
#endif
...
/*==================================================================*/
#define MT9M034_CHIP_VERSION	0x2400

#define MT9M034_HDR_SEQUENCE_TBL_SIZE (275)
#define MT9M034_LINEAR_SEQUENCE_TBL_SIZE (277)

#define MT9M034_HDR_TBL_SIZE	(37)
#define MT9M034_LINEAR_TBL_SIZE	(44)

#define MT9M034_DEFAULT_OUTPUT_WIDTH	1280
#define MT9M034_DEFAULT_OUTPUT_HEIGHT	720

/* Version 1.0.0.1 modification, 2012.08.06 */
/* Version 1.0.0.2 modification, 2012.11.02 */
/* Version 1.0.0.3 modification, 2012.11.09 */
/* Version 1.0.0.6 modification, 2013.12.02 */
#define MT9M034_MAX_GAIN 184310
/* ========================== */
/* ========================== */
/* ========================== */
/* ========================== */

#define MT9M034_PIXEL_CLOCK	74250000
#define MT9M034_PIXEL_CLOCK_M_100	(MT9M034_PIXEL_CLOCK/10000)

/* Version 1.0.0.5 modification, 2013.01.30 */
/* Version 1.0.0.6 modification, 2013.12.02 */
#define MT9M034_HSYNC_1280x960_45FPS	1650
#define MT9M034_VSYNC_1280x960_45FPS	1000

#define MT9M034_HSYNC_1280x960_40FPS	1650
#define MT9M034_VSYNC_1280x960_40FPS	1125

#define MT9M034_HSYNC_1280x720_60FPS	1650
#define MT9M034_VSYNC_1280x720_60FPS	750

#define MT9M034_HSYNC_1280x720_50FPS	1650
#define MT9M034_VSYNC_1280x720_50FPS	900
/* ========================== */

/* Version 1.0.0.1 modification, 2012.08.06 */
#define MT9M034_HSYNC_1280x800_60FPS	1500
#define MT9M034_VSYNC_1280x800_60FPS	830	
/* ========================== */

#define MT9M034_HSYNC_1280x800_50FPS	1500
#define MT9M034_VSYNC_1280x800_50FPS	991	
/* ========================== */

typedef enum MT9M034_registers
{
...
typedef struct MT9M034_reg_addr_data
{
    EMT9M034Regs eRegAddr;
    DWORD dwData;
} TMT9M034RegAddrData;

typedef struct MT9M034_info
{
	spinlock_t lock;
