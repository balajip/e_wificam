			  ...
			  int *lpt_lebs, int *big_lpt)
{
	...
	*lpt_lebs = c->lpt_lebs;
	...
	buf = Mozart_vmalloc(c->leb_size);
	ltab = Mozart_vmalloc(sizeof(struct ubifs_lpt_lprops) * c->lpt_lebs);
...
static int lpt_init_rd(struct ubifs_info *c)
{
	...
	c->ltab = Mozart_vmalloc(sizeof(struct ubifs_lpt_lprops) * c->lpt_lebs);
	if (!c->ltab)
		return -ENOMEM;
...
static int lpt_init_wr(struct ubifs_info *c)
{
	...
	c->ltab_cmt = Mozart_vmalloc(sizeof(struct ubifs_lpt_lprops) * c->lpt_lebs);
	if (!c->ltab_cmt)
		return -ENOMEM;

	c->lpt_buf = Mozart_vmalloc(c->leb_size);
	if (!c->lpt_buf)
		return -ENOMEM;
