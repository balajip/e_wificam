...
#ifndef    __ROSSINI_AGPO_H
#define    __ROSSINI_AGPO_H
#define ROSSINI_N_AGPO 8
 ...
 *
 * AGPOs are numbered 0..(ROSSINI_N_AGPO-1). For documentation, and maybe
...
typedef struct
{
    unsigned long agpo_status[ROSSINI_N_AGPO];
