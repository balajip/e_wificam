...
#define PUTS_UART_BASE MOZART_UARTC0_MMR_BASE
#elif defined(CONFIG_UART_PORT_NUM_1)
#define PUTS_UART_BASE MOZART_UARTC1_MMR_BASE
#elif defined(CONFIG_UART_PORT_NUM_2)
#define PUTS_UART_BASE MOZART_UARTC2_MMR_BASE
#elif defined(CONFIG_UART_PORT_NUM_3)
#define PUTS_UART_BASE MOZART_UARTC3_MMR_BASE
#else
#error "You have to select correct UART-PORT-NUMBER(0~3)!!"
#endif
    //#define PUTS_UART_BASE MOZART_UARTC2_MMR_BASE
	//#define PUTS_UART_BASE MOZART_UARTC1_MMR_BASE//james_test
