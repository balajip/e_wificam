...
void setup_initrd_tag (bd_t *bd, ulong initrd_start,
			      ulong initrd_end);
# endif
...
void setup_start_tag (bd_t *bd)
{
	params = (struct tag *) bd->bi_boot_params;//this is assigned by BOOT_PARAMS_ADDR(0x100)
