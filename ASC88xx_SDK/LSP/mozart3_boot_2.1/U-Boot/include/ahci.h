...
struct ahci_ioports {
	...
	unsigned long	cmd_tbl;
	unsigned long	rx_fis;
};

struct ahci_probe_ent {
	pci_dev_t	dev;
	struct ahci_ioports	port[AHCI_MAX_PORTS];
	unsigned long	n_ports;
	unsigned long	hard_port_no;
	...
	unsigned long	flags;
	unsigned long	cap;	/* cache of HOST_CAP register */
	unsigned long	port_map; /* cache of HOST_PORTS_IMPL reg */
	unsigned long	link_port_map; /*linkup port map*/
};
