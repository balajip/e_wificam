#ifndef __BEETHOVEN_QUICKTEST_H__
#define __BEETHOVEN_QUICKTEST_H__

extern int spi_flash_test_func(void) ;
extern int uart_test_func(void) ;
...
extern int nand_test_func(void) ;
