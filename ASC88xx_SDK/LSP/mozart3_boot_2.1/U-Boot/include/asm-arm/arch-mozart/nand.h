...
#define VPL_BRC_BASE       VPL_BRC_ROM_BASE_REMAPPED
#define VPL_BRC_SRAM_BASE  (VPL_BRC_BASE + 0x1000)
#define VPL_BRC_VERSION    (VPL_BRC_BASE + 0x4000)
#define VPL_BRC_CTRL       (VPL_BRC_BASE + 0x4004)
