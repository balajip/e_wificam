#ifndef __BEETHOVEN_EVM_H__
#define __BEETHOVEN_EVM_H__

#define CONFIG_SOC_BEETHOVEN   1
...
#define PLATFORM_RS485_PORTNUM				1//RS485 uses uart port(#0~#3, -1 means no rs485)
#define PLATFORM_DRAM_NUM					4
#define PLATFORM_SPIFLASH_NUM				1//0 or 1 or 2
#define PLATFORM_NANDFLASH_NUM				1
#define PLATFORM_SDCARD_NUM					1//At most 2, but "sdread" only reads SD card in the "first" slot.
#define PLATFORM_USB_NUM					0//0 or 1
#define PLATFORM_PCIE_NUM					0//0 or 1
#define PLATFORM_DIDO_NUM					0//0 or 1
...
#define	PLATFORM_QUICKTEST_AUTORUN_ENABLE	1
#endif
...
#define CONFIG_SF_DEFAULT_SPEED             25000000 /* 25 MHz */
...
#undef SD_AUTORUN /* script autorun */
#ifdef SD_AUTORUN
...
/********* DRAM *********/
#if (PLATFORM_DRAM_NUM > 4)
#define CONFIG_DRAM_NUMBER					4 //the max DRAM number Our UBoot can see
#else
...
#define PLATFORM_DI_PIN 14
#define PLATFORM_DO_PIN 15
#endif
 ...
 * it also supports automatically quick test when booting if enable macro "CONFIG_AUTO_QUICK_TEST".
 */
#if (PLATFORM_QUICKTEST_ENABLE)
#define CONFIG_QUICK_TEST

#if (PLATFORM_QUICKTEST_AUTORUN_ENABLE)
#define CONFIG_AUTO_QUICK_TEST
#endif
#endif//(PLATFORM_QUICKTEST_ENABLE == 1)
...
#define MOZART_GPIOC_BASE					0x49000000
#define MOZART_AGPOC_BASE					0x49800000
...
#define MOZART_RTC_SCL						0x00001000
#define MOZART_RTC_SDA						0x00002000
#endif
...
#define	CONFIG_BOOTCOMMAND_NF				"run setargs;"\
							"nand read 0xa00000 kernel 0x1d0000;"\
							"jump 0xa00000"
#ifdef SD_AUTORUN
#define CONFIG_BOOTCOMMAND_MMC				"setenv bootargs ${bootargs} ${mtdparts};"\
							"tftp 0xa00000 sd-autorun.scr; source 0xa00000"
#else
...
#define CONFIG_BOOTARGS_MMC                             "root=/dev/ram0 ro initrd=0x3000000,8M mem=64M console=0"
#elif (PLATFORM_CONSOLE == 1)
#define CONFIG_BOOTARGS                                 "root=/dev/mtdblock2 mem=64M console=1"
#define CONFIG_BOOTARGS_MMC                             "root=/dev/ram0 ro initrd=0x3000000,8M mem=64M console=1"
#elif (PLATFORM_CONSOLE == 2)
#define CONFIG_BOOTARGS                                 "root=/dev/mtdblock2 mem=64M console=2"
#define CONFIG_BOOTARGS_MMC                             "root=/dev/ram0 ro initrd=0x3000000,8M mem=64M console=2"
#elif (PLATFORM_CONSOLE == 3)
#define CONFIG_BOOTARGS	                                "root=/dev/mtdblock2 mem=64M console=3"
#define CONFIG_BOOTARGS_MMC                             "root=/dev/ram0 ro initrd=0x3000000,8M mem=64M console=3"
#endif
...
//#define CONFIG_MODELNAME          			"Beethoven"
...
#define MTDIDS_DEFAULT						"nand0=Beethoven-nand"
#define MTDPARTS_DEFAULT					"mtdparts=Beethoven-nand:1280k(bootldr),640k(env),4m(kernel),16m(rootfs),-(ubifs)"
#endif
 ...
 *===					#3. Misc                   ===*
 *====================================================*/
/********* Reduce the code and shrink the size *********/
#if 0
#define CONFIG_REDUCE_CODE 1
#ifndef CONFIG_REDUCE_CODE
#define CONFIG_AUTO_COMPLETE       1
#endif
#endif

#define CONFIG_CMDLINE_EDITING				1
#define LOADER_VERSION_OFFSET				0xA0002000
#define BOOTING_DEVICE_INFO				0xA0002004
