...
#define U64_TO_U32_LOW(val)	((unsigned long)((val) & 0x00000000ffffffffULL))
#define U64_TO_U32_HIGH(val)	((unsigned long)((val) >> 32))
...
static inline unsigned long sdr_base(int port)
{
	switch (port) {
