#ifndef __GAMC_MOZART_H__
#define __GAMC_MOZART_H__
...
enum InitialRegisters
{
  GmacConfigInitFdx1000       /* Full-duplex mode with perfect filter on */
                          ...
                          = GmacWatchdogEnable | GmacJabberEnable         | GmacFrameBurstDisable | GmacJumboFrameDisable
#endif
...
// Hash filter.
																		/* disable broadcast frame to avoid TFTP command error */
                          = GmacFilterOn          | GmacPassControl0   | GmacBroadcastDisable |  GmacSrcAddrFilterDisable
...
#ifdef CONFIG_SOC_HAYDN
                          = DmaFixedBurstEnable |   DmaBurstLength8   | DmaDescriptorSkip0       | DmaResetOff,
#elif (defined(CONFIG_SOC_MOZART))
                            = DmaBurstLength16   | DmaDescriptorSkip0       | DmaResetOff,
#endif

  DmaControlInit1000      /* 1000 Mb/s mode */
                          = DmaStoreAndForward       | DmaTxSecondFrame |0x00000040,

  DmaControlInit100       /* 100 Mb/s mode */
                          = DmaStoreAndForward |0x00000040,
