...
unsigned long bdf;
unsigned long iobase1 = 0;		/*Primary cmd block */
unsigned long iobase2 = 0;		/*Primary ctl block */
unsigned long iobase3 = 0;		/*Sec cmd block */
unsigned long iobase4 = 0;		/*sec ctl block */
unsigned long iobase5 = 0;		/*BMDMA*/
int
pci_sata_init (void)
{
	unsigned long bus = PCI_SATA_BUS;
	unsigned long dev = PCI_SATA_DEV;
	unsigned long fun = PCI_SATA_FUNC;
	u16 cmd = 0;
