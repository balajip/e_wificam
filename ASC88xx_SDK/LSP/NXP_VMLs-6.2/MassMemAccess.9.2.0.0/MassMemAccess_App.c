/*
* $Header: /rd_2/project/Mozart/Linux_Libraries/MassMemAccess/MassMemAccess_App/MassMemAccess_App.c 48    14/03/18 2:41p Yiming.liu $
*
 ...
 * 
 * *****************  Version 48  *****************
 * User: Yiming.liu   Date: 14/03/18   Time: 2:41p
...
/* ======================================== */
/* Version 9.2.0.0 modification, 2014.03.18 */
		tOptions.adwUserData[0] = 2;
        tOptions.eOptionFlags = VIDEO_SIGNAL_OPTION_SET_DATA_WIDTH_FLAG;
        if (MassMemAccess_SetOptions(hObject, &tOptions) != S_OK)
        {
            printf("Fail to set up data width flag !!\n");
            goto PROCESS_1D_QUIT;
        }
        else
        {
            printf("Set up data width flag successfully !!\n");
        }
/* ======================================== */
