/*
 * $Header: /rd_2/project/Rossini/Components/VIC/Device_Driver/VIC/global_codec.h 222   14/10/31 3:55p Joe.tu $
 *
 * Driver for EDMC.
 *
 ...
 * 
 * *****************  Version 222  *****************
 * User: Joe.tu       Date: 14/10/31   Time: 3:55p
 * Updated in $/rd_2/project/Rossini/Components/VIC/Device_Driver/VIC
 * 
 * *****************  Version 221  *****************
 * User: Jaja         Date: 14/10/16   Time: 11:15a
 * Updated in $/rd_2/project/Mozart/Linux_Libraries/H264Enc/H264Enc_Lib
 * 
 * *****************  Version 220  *****************
 * User: Joe.tu       Date: 14/09/29   Time: 6:39p
 * Updated in $/rd_2/project/Rossini/Components/VIC/Device_Driver/VIC
 * 
 * *****************  Version 219  *****************
 ...
 * 
 * *****************  Version 218  *****************
 * User: Angel        Date: 14/08/15   Time: 3:49p
 * Updated in $/rd_2/project/Mozart/Linux_Libraries/H264Enc/H264Enc_Lib
 * 
 * *****************  Version 217  *****************
 * User: Angel        Date: 14/08/13   Time: 7:30p
 * Updated in $/rd_2/project/SoC/Linux_Libraries/MassMemAccess/MassMemAccess_Lib
 * 
 * *****************  Version 216  *****************
 * User: Angel        Date: 14/08/13   Time: 2:01p
 * Updated in $/rd_2/project/SoC/Linux_Libraries/MassMemAccess/MassMemAccess_Lib
 * 
 * *****************  Version 215  *****************
 * User: Joe.tu       Date: 14/07/08   Time: 5:27p
 * Updated in $/rd_2/project/Mozart/Components/VIC/Device_Driver/VIC_3.0.0.0
 * 
 * *****************  Version 214  *****************
 * User: Morgan.chang Date: 14/06/12   Time: 5:31p
 * Updated in $/rd_2/project/SoC/Linux_Libraries/Sample/MemMgr_Lib
 * Fix version typo: from 4.0.0.122 to 4.0.0.12
 * 
 * 1. Add macro MAKEVERSTR to generate version string
 * 2. Re-order the inclusion of vpl_edmc.h.
 *    Defer the inclusion of vpl_edmc.h after global_codec.h to avoid
 * including
 * the global_codec.h in vpl_edmc's location. 
 * 
 * *****************  Version 213  *****************
 ...
 * 
 * *****************  Version 211  *****************
 * User: Jaja         Date: 14/05/28   Time: 3:34p
 * Updated in $/rd_2/project/Mozart/Linux_Libraries/H264Enc/H264Enc_Lib
 * 
 * *****************  Version 210  *****************
 * User: Yiming.liu   Date: 14/03/18   Time: 2:35p
 * Updated in $/rd_2/project/Mozart/Linux_Libraries/MassMemAccess/MassMemAccess_Lib
 * MODIFICATION: Add VIDEO_SIGNAL_OPTION_SET_DATA_WIDTH_FLAG option to
 ...
 *
 * \brief
 * ______'s Audio/Video codec common callback function definitions
 *
 * \date
 * 2002/04/25
 *
...
#define MAKEVERSTR(major, minor, build, revision)   _makeverstr(major, minor, build, revision)
#endif
...
typedef enum video_signal_option_flags
{
	...
	VIDEO_SIGNAL_OPTION_SET_DATA_WIDTH_FLAG = 78,
	VIDEO_SIGNAL_OPTION_SET_VIDEO_FRAME_FORMAT = 79,
	VIDEO_SIGNAL_OPTION_AUTO_EXPOSURE_CONTROL = 80,
	VIDEO_SIGNAL_OPTION_AUTO_WHITE_BALANCE_CONTROL = 81,
	VIDEO_SIGNAL_OPTION_FIXED_PATTERN_NOISE_CORRECT_CONTROL = 82,
	VIDEO_SIGNAL_OPTION_COLOR_ABERRATION_CORRECT_CONTROL = 83,
	VIDEO_SIGNAL_OPTION_DEFECT_PIXEL_CORRECT_CONTROL = 84,
	VIDEO_SIGNAL_OPTION_DECOMPANDING_CONTROL = 85,
	VIDEO_SIGNAL_OPTION_BLACK_CLAMP_CONTROL = 86,
	VIDEO_SIGNAL_OPTION_LENS_SHADING_CORRECT_CONTROL = 87,
	VIDEO_SIGNAL_OPTION_LOCAL_TONE_MAPPING_CONTROL = 88,
	VIDEO_SIGNAL_OPTION_COLOR_CORRECTION_CONTROL = 89,
	VIDEO_SIGNAL_OPTION_COLOR_TRANSFORM_CONTROL = 90,
	VIDEO_SIGNAL_OPTION_GAMMA_CONTROL = 91,
	VIDEO_SIGNAL_OPTION_SATURATION_BRIGHTNESS_CONTRAST_CONTROL = 92,
	VIDEO_SIGNAL_OPTION_CONTRAST_ENHANCE_CONTROL = 93,
	VIDEO_SIGNAL_OPTION_CLIP_CONTROL = 94,
	VIDEO_SIGNAL_OPTION_MIRROR_FLIP_CONTROL = 95,
	VIDEO_SIGNAL_OPTION_NOISE_REDUCT_STATISTIC_CONTROL = 96,
	VIDEO_SIGNAL_OPTION_AUTO_FOCUS_CONTROL = 97,
	VIDEO_SIGNAL_OPTION_IR_CUT_CONTROL = 98,

	// [NOTE]!! MAXIMUM NUMBER is 98
...
{
	COLOR_FORMAT_MONO = 1,
	COLOR_FORMAT_YCBCR420 = 10,
	COLOR_FORMAT_YCBCR422 = 11,
	COLOR_FORMAT_YCBCR444 = 12,
	COLOR_FORMAT_NV12 = 13,
	COLOR_FORMAT_BAYER = 20,
	COLOR_FORMAT_RGB24 = 30
} EColorFormat;
...
typedef enum video_option_flags
{
	...
	VIDEO_CHANGE_H264_ENTROPY_MODE = 68,
	VIDEO_CHANGE_H264_VUI_HEADER_ASPECT_RATIO_INFO = 69,
	VIDEO_COMPILANT_H264_TWO_CONSECTIVE_MB_MAXMV_CONSTRAINT = 70,
	VIDEO_CHANGE_H264_VUI_HEADER_EN = 71,
	VIDEO_CHANGE_H264_ENCODE_CHROMA_QP_OFFSET = 72,
	VIDEO_RESET = 73,
	VIDEO_CHANGE_H264_MV_RANGE_AND_PI_QUALITY = 74,
	VIDEO_SET_H264_PAYLOAD_TPYE_1_TIME_INFO = 75
} EVideoOptionFlags;
...
{
          EColorFormat eColorFormat;				// input and output
          DWORD dwWidth;							// input and output
          DWORD dwHeight;							// input and output
          DWORD dwStride;							// input and output
          DWORD adwHWInfo[12];						// it is used for exchanging information between hardware engines.
          BYTE *apbyBuff[3];						// input
} TFrameBuff;
...
{
	/* open function */
	int (*open)(TVideoSensorInitialParam* ptParam, DWORD dwChnNum);
	/* release function */
	int (*release)(DWORD dwChnNum);
	/* ioctl function */
	int (*ioctl)( TVideoSignalOptions* ptArg, DWORD dwChnNum);
	/* getting current shutter value function */
	DWORD (*get_shutter_value)(DWORD dwChnNum);
	/* getting sensor remaining line function */
	DWORD (*get_remaining_line_num)(DWORD dwChnNum);
	/* grouping access function */
	int (*group_access)(int status, DWORD dwChnNum);
	/* detect NTSC/PAL standard */
	int (*detect_standard)(DWORD dwChnNum, TAutoDetectStdInfo *ptInfo);
	/* setup NTSC/PAL standard */
	int (*setup_standard)(DWORD dwChnNum, ETVStd eStd);
	/* get ae statistic from sensor */
	int (*get_exp_statistic)(TVideoSensorStatistic *ptParam, DWORD dwChnNum);
	/* get wb statistic from sensor */
	int (*get_wb_statistic)(TVideoSensorStatistic *ptParam, DWORD dwChnNum);
	/* getting sensor max gain function */
	DWORD (*get_max_gain)(DWORD dwChnNum);
} TVideoSensorDevice;
...
typedef struct iris_motor_device
{
	...
	int  (*control)(DWORD dwCmd,  DWORD dwArg, DWORD dwDevNum);
...
typedef struct autofocus_motor_device
{
	...
	int (*control)(unsigned int dwCmd, DWORD dwArg, DWORD dwDevNum);
