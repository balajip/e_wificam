/*
 * $Header: /rd_2/project/Mozart/Linux_Libraries/ImgBackEndProcess_3.0.0.0/ImgBackEndProcess_Lib/global_codec.h 198   12/12/19 7:24p Linus.huang $
 *
 * Driver for EDMC.
 *
