/*
 * $Header: /rd_2/project/SoC/Simulation_Models/Sample_C_Simulation/VPL_AHBC_Lib/typedef.h 29    13/04/26 5:17p Frank.yang $
 *
 * Driver for EDMC.
 *
 ...
 * 
 * *****************  Version 29  *****************
 * User: Frank.yang   Date: 13/04/26   Time: 5:17p
 * Updated in $/rd_2/project/SoC/Simulation_Models/Sample_C_Simulation/VPL_AHBC_Lib
 * MODIFICATION: Add checks for the local RAM size of the compression
 * module.
 * 
 * *****************  Version 26  *****************
