/*
 * $Header: /rd_2/project/Mozart/Components/VIC/Device_Driver/VIC/global_codec.h 186   12/04/02 10:38a Joe.tu $
 *
 * Driver for EDMC.
 *
...
/* DCIris call back function */
struct DCIris_device {
	int (*open)(void);
	void (*release)(void);
	int  (*control)(SDWORD sdwCurrDCIrisMove,  DWORD dwCurrDCIrisSpeed);
};
/* ====================================================================================== */
// With respective to CMOS sensor
typedef enum autofocus_move_direction_flags
{
	AUTO_FOCUS_NO_MOVE = 0,
	AUTO_FOCUS_MOVE_2_NEAR = 1,
	AUTO_FOCUS_MOVE_2_FAR = 2,    
} EAutoFocusMoveDirectionFlags;

/* Auto-Focus motor control options */
typedef enum af_motor_control_flags
{
	AF_MOTORCTRL_STOPALLMOTOR = 1,
	AF_MOTORCTRL_FOCUS_STOPMOTOR = 2,
	AF_MOTORCTRL_FOCUS_RESETMOTOR = 3,
	AF_MOTORCTRL_FOCUS_GET_MOTORPOSITION = 4,
	AF_MOTORCTRL_FOCUS_GET_MOTORRANGE = 5,
	AF_MOTORCTRL_FOCUS_MOTORAWAY = 6,
	AF_MOTORCTRL_FOCUS_MOTORAPPROACH = 7,
	AF_MOTORCTRL_FOCUS_MOTOR2NEAR = 8,
	AF_MOTORCTRL_ZOOM_STOPMOTOR = 9,
	AF_MOTORCTRL_ZOOM_RESETMOTOR = 10,
	AF_MOTORCTRL_ZOOM_GET_MOTORPOSITION = 11,
	AF_MOTORCTRL_ZOOM_GET_MOTORRANGE = 12,
	AF_MOTORCTRL_ZOOMOUT = 13,
	AF_MOTORCTRL_ZOOMIN = 14,
	AF_MOTORCTRL_ZOOM_MOTOR2TELE = 15,
	AF_MOTORCTRL_ZOOM_MOTOR2WIDE = 16,
	AF_MOTORCTRL_FOCUS_MOTOR2FAR = 17,
	AF_MOTORCTRL_ZOOM_GET_MAXRATIO = 18,
} EAFMotorControlFlags;
